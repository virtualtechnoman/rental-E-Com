...
export class OrderComponent implements OnInit {
  ...
  changeItemReturnedStatus(event,i) {
    ...
    object['returned'] = event.checked;
    this.customersService.changeItemReturnedStatus(object).subscribe((res: ResponseModel) => {
      console.log(res);
      if (res.errors) {
  ...
  changeDepositRefundStatus(event,i) {
    ...
    object['product'] = this.selectedOrder.products[i].product._id;
    object['order'] = this.selectedOrder._id;
    object['depositRefunded'] = event.checked;
    this.customersService.changeDepositRefundStatusForOrder(object).subscribe((res: ResponseModel) => {
      console.log(res);
      if (res.errors) {
        this.toasterService.error('error while fetching');
      } else {
