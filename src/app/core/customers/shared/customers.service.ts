...
export class CustomersService {
  ...
  changeItemReturnedStatus(data) {
    return this.http.put(this.url11 + '/return', data, { headers: this.headers });
  }

  changeDepositRefundStatusForOrder(data) {
    return this.http.put(this.url11 + '/depositrefund', data, { headers: this.headers });
  }
}
